...
while choice != "Exit"
  ...
  if choice == "Search by Input" #Searches Pokemon by typing prompt.
    ...
    while gen != "Exit"
      ...
      if gen == "Generation I" 
        genquery = PokeApi.get(pokemon: {limit: 151, offset: 0}).results.map {|p| p.name}
        ...
        genquery = PokeApi.get(pokemon: {limit: 100, offset: 151}).results.map {|p| p.name}
        genchoice = prompt.select("Please select your Pokemon", genquery , per_page: 30, cycle: true)
        pokequery = PokeApi.get(pokemon: genchoice)
        puts "\nID: " + "#{pokequery.id}" + " - " + pokequery.name.capitalize
        puts "Type: " + pokequery.types.map {|t| t.type.name.capitalize}.join(" & ")
        ...
        genquery = PokeApi.get(pokemon: {limit: 135, offset: 251}).results.map {|p| p.name}
        genchoice = prompt.select("Please select your Pokemon", genquery , per_page: 30, cycle: true)
        pokequery = PokeApi.get(pokemon: genchoice)
        puts "\nID: " + "#{pokequery.id}" + " - " + pokequery.name.capitalize
        puts "Type: " + pokequery.types.map {|t| t.type.name.capitalize}.join(" & ")
        ...
        genquery = PokeApi.get(pokemon: {limit: 107, offset: 386}).results.map {|p| p.name}
        genchoice = prompt.select("Please select your Pokemon", genquery , per_page: 30, cycle: true)
        pokequery = PokeApi.get(pokemon: genchoice)
        puts "\nID: " + "#{pokequery.id}" + " - " + pokequery.name.capitalize
        puts "Type: " + pokequery.types.map {|t| t.type.name.capitalize}.join(" & ")
        ...
        genquery = PokeApi.get(pokemon: {limit: 156, offset: 493}).results.map {|p| p.name}
        genchoice = prompt.select("Please select your Pokemon", genquery , per_page: 30, cycle: true)
        pokequery = PokeApi.get(pokemon: genchoice)
        puts "\nID: " + "#{pokequery.id}" + " - " + pokequery.name.capitalize
        puts "Type: " + pokequery.types.map {|t| t.type.name.capitalize}.join(" & ")
        ...
        genquery = PokeApi.get(pokemon: {limit: 72, offset: 649}).results.map {|p| p.name}
        genchoice = prompt.select("Please select your Pokemon", genquery , per_page: 30, cycle: true)
        pokequery = PokeApi.get(pokemon: genchoice)
        puts "\nID: " + "#{pokequery.id}" + " - " + pokequery.name.capitalize
        puts "Type: " + pokequery.types.map {|t| t.type.name.capitalize}.join(" & ")
        ...
        genquery = PokeApi.get(pokemon: {limit: 86, offset: 721}).results.map {|p| p.name}
        genchoice = prompt.select("Please select your Pokemon", genquery , per_page: 30, cycle: true)
        pokequery = PokeApi.get(pokemon: genchoice)
        puts "\nID: " + "#{pokequery.id}" + " - " + pokequery.name.capitalize
        puts "Type: " + pokequery.types.map {|t| t.type.name.capitalize}.join(" & ")
